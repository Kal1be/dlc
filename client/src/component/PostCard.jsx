...
const PostCard = ({ post }) => {
  ...
  return (
    <div className='group mt-6 relative w-full shadow-sm border rounded-lg sm:w-[350px] scrollbar h-[370px] overflow-hidden'>
      ...
      <div className='flex flex-col p-3 gap-2 '>
        ...
        <span className='font-bold font-sans text-lg'>{post.category}</span>
